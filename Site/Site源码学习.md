...
[SiteCerModel](file:///home/liaoya/github/LearnNote/Site/SiteCertModel.md)继承[CertModel](file:///home/liaoya/github/LearnNote/Site/CertModel.md)继承[ListModel](file:///home/liaoya/github/LearnNote/Site/ListModel.md)继承[InterceptorContainer](file:///home/liaoya/github/LearnNote/Site/InterceptorContainer.md)继承
...
case "deleteCert":
case "selfSign":
	$wf->onSubmit($_REQUEST["opType"], $_REQUEST);
	break;
}
```
其中，is_uploaded_file是判断该文件是否是通过HTTP POST上传的，是则返回true。
...
`SiteCertMode`继承`CertModel`，则`SiteCertMode`的类结构如下所示:
```
